    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='lead-paragraph'>
          <p>
            <span className="skyblue">{config.organizationName}</span> {t("home.presentation.site-description")}
          </p>
          <br />
          <p className="bold">
            {t("home.presentation.steps-instructions")}
          </p>
        </div>
          ...
          <div className='row'>
            <div className='section-icon col-md-4'>
              <img
                ...
                alt={t("home.presentation.step1.title")}
              />
              <div className='text'>
                <h5>{t("home.presentation.step1.title")}</h5> {t("home.presentation.step1.text")}
              </div>
            </div>
            <div className='section-icon col-md-4'>
             <img
                ...
                alt={t("home.presentation.step2.title")}
              />
              <div className='text'>
                <h5>{t("home.presentation.step2.title")}</h5> {t("home.presentation.step2.text")}
              </div>
            </div>
            <div className='section-icon col-md-4'>
             <img
                ...
                alt={t("home.presentation.step3.title")}
              />
              <div className='text'>
                <h5>{t("home.presentation.step3.title")}</h5> {t("home.presentation.step3.text")}
              </div>
            </div>
          </div>
        </div>
