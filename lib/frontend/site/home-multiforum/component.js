    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='section-icons col-md-10 offset-md-1'>
          <div className='row'>
            <div className='lead-paragraph texto-presentacion'>
          ...
          <div className='row'>
            <div className='section-icon col-md-4'>
              <a
                ...
                target="_blank"
                href={t("homepage.presentation.step1.link")}>
                <img
                  className='icon'
            ...
            <div className='section-icon section-icon-2 col-md-4' onClick={this.handleButtonClick}>
             <img
                className='icon'
            ...
            <div className='section-icon col-md-4'>
              <a
                rel="noopener noreferer"
                target="_blank"
                href="https://www.nuestraamericaverde.org/">
               <img
                  className='icon'
