          ...
          <div className="col-md-8 offset-md-2">
            <div className="row">
              <div className="col-md-4 stat-container">
                <div className="stat-title">{t("comments.plural")}<br />{t("comments.done")}</div>
                {
              ...
              <div className="col-md-4 stat-container">
                <div className="stat-title">{t("comments.plural")}<br />{t("comments.answered")}</div>
                {
                  this.state.isFetching ?
                  <div className="spinning-loader"></div>
              ...
              <div className="col-md-4 stat-container">
                <div className="stat-title">{t("comments.participants-who-commented")}</div>
                {
                  this.state.isFetching ?
                  <div className="spinning-loader"></div>
